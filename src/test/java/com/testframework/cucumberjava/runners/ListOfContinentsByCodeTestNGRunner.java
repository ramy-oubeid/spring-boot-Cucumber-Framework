...
@CucumberOptions(
        features = "src/test/resources/features/ListOfContinentsByCode.feature",
...
public class ListOfContinentsByCodeTestNGRunner extends AbstractTestNGCucumberTests {
