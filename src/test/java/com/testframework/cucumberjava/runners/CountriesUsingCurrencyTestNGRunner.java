...
@CucumberOptions(
        features = "src/test/resources/features/CountriesUsingCurrency.feature",
...
public class CountriesUsingCurrencyTestNGRunner extends AbstractTestNGCucumberTests {
