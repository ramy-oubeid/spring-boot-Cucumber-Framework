...
@CucumberOptions(
        features = "src/test/resources/features/FullCountryInfoAllCountries.feature",
...
public class FullCountryInfoAllCountriesTestNGRunner extends AbstractTestNGCucumberTests {
