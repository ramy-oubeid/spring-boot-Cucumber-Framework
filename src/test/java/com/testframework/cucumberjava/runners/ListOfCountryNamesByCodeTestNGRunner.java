...
@CucumberOptions(
        features = "src/test/resources/features/ListOfCountryNamesByCode.feature",
...
public class ListOfCountryNamesByCodeTestNGRunner extends AbstractTestNGCucumberTests {
