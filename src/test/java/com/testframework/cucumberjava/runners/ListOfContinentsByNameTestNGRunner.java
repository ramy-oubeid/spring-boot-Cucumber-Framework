...
@CucumberOptions(
        features = "src/test/resources/features/ListOfContinentsByName.feature",
...
public class ListOfContinentsByNameTestNGRunner extends AbstractTestNGCucumberTests {
