...
@CucumberOptions(
        features = "src/test/resources/features/ListOfCurrenciesByName.feature",
...
public class ListOfCurrenciesByNameTestNGRunner extends AbstractTestNGCucumberTests {
