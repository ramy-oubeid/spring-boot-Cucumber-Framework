...
@CucumberOptions(
        features = "src/test/resources/features/ListOfCountryNamesByName.feature",
...
public class ListOfCountryNamesByNameTestNGRunner extends AbstractTestNGCucumberTests {
