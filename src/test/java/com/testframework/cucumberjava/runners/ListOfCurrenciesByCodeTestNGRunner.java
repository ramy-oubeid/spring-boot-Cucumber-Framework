...
@CucumberOptions(
        features = "src/test/resources/features/ListOfCurrenciesByCode.feature",
...
public class ListOfCurrenciesByCodeTestNGRunner extends AbstractTestNGCucumberTests {
