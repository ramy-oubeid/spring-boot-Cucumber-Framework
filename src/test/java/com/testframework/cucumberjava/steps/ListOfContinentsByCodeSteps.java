...
public class ListOfContinentsByCodeSteps {
    ...
    public void iSendASOAPRequestToListOfContinentsByCode() {
    ...
    public void iShouldReceiveAResponseFromListOfContinentsByCode() {
