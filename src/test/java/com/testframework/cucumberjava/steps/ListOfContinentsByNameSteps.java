...
public class ListOfContinentsByNameSteps {
    ...
    public void iSendASOAPRequestToListOfContinentsByName() {
    ...
    public void iShouldReceiveAResponseFromListOfContinentsByName() {
