...
public class ListOfCurrenciesByNameSteps {
    ...
    public void iSendASOAPRequestToListOfCurrenciesByName() {
    ...
    public void iShouldReceiveAResponseFromListOfCurrenciesByName() {
