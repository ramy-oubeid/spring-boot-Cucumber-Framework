...
public class ListOfCountryNamesByCodeSteps {
    ...
    public void iSendASOAPRequestToListOfCountryNamesByCode() {
    ...
    public void iShouldReceiveAResponseFromListOfCountryNamesByCode() {
