...
public class CountriesUsingCurrencySteps {
    ...
    public void iSendASOAPRequestToCountriesUsingCurrency() {
    ...
    public void iShouldReceiveAResponseFromCountriesUsingCurrency() {
